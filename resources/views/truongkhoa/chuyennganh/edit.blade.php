...
@section('content')
    ...
    <div class="btn-group" role="group">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('tkchuyennganh.update',$tkchuyennganh->id)}}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="MaKhoa" value="{{$tkchuyennganh->MaChuyenNganh}}" class="form-control" placeholder="Nhập mã khoa">
                            </div>
                            <div class="form-group">
                                <strong>Tên chuyên ngành</strong>
                                <input type="text" name="TenChuyenNganh" value="{{$tkchuyennganh->TenChuyenNganh}}" class="form-control" placeholder="Nhập tên khoa">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <strong>Mô tả</strong>
                                <input type="text" name="MoTa" value="{{$tkchuyennganh->MoTa}}" class="form-control" placeholder="Nhập mô tả ">
                            </div>
                        </div>
