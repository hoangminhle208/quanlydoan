        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a href="{{route('tktaodotdk.index')}}" class="btn btn-primary float-end">Danh sách khoa</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <form action="{{route('tktaodotdk.store')}}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <strong>Ngày bắt đầu</strong>
                                <input type="date" name="start" class="form-control" placeholder="Chọn ngày bắt đầu">
                            </div>
                            <div class="form-group">
                                <strong>Ngày kết thúc</strong>
                                <input type="date" name="end" class="form-control" placeholder="Chọn ngày kết thúc">
                            </div>
                            <div class="form-group">
