        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a href="{{route('chuyennganh.create')}}" class="btn btn-primary float-end" >Thêm mới</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$cn->MoTa}}</td>
                            <td>
                                <form action="{{route('chuyennganh.destroy',$cn->id)}}" method="POST">
                                    <a href="{{route('chuyennganh.edit',$cn->id)}}" class="btn btn-info">Sửa</a>
                                    @csrf
                                    @method('DELETE')
