        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a href="{{route('lop.index')}}" class="btn btn-primary float-end">Danh sách khoa</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <form action="{{route('lop.store')}}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <strong>Sĩ số</strong>
                                <input type="int" name="SiSo" class="form-control" placeholder="Nhập sĩ số ">
                            </div>
                            <!-- <div class="form-group">
                                <strong>Mã Niên khóa</strong>
                                <input type="text" name="MaNienKhoa" class="form-control" placeholder="Nhập mã niên khóa ">
                            </div> -->
                            <div class="form-group">
