...
<div class="btn-group" role="group" aria-label="Button group with nested dropdown">
    ...
    <div class="btn-group" role="group">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('hedaotao.update',$hedaotao->id)}}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$hedaotao->MaHeDaoTao}}" name="MaHeDaoTao" class="form-control">
                            </div>
                            <div class="form-group">
                                <strong>Tên hệ đào tạo</strong>
                                <input type="text" value="{{$hedaotao->TenHeDaoTao}}" name="TenHeDaoTao" class="form-control">
                            </div>
                            <div class="form-group">
                                <strong>Mô tả</strong>
                                <input type="text" value="{{$hedaotao->MoTa}}" name="MoTa" class="form-control">
                            </div>
                        </div>
