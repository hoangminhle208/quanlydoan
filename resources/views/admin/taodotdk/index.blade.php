        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a href="{{route('taodotdk.create')}}" class="btn btn-primary float-end" >Thêm mới</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{route('taodotdk.destroy',$dk->id)}}" method="POST">
                                    <a href="{{route('taodotdk.edit',$dk->id)}}" class="btn btn-info">Sửa</a>
                                    @csrf
                                    @method('DELETE')
