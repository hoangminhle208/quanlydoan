        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a href="{{route('taodotdk.index')}}" class="btn btn-primary float-end">Danh sách đợt đăng ký</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <form action="{{route('taodotdk.update',$taodotdk->id)}}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="start" value="{{$taodotdk->start}}" class="form-control" placeholder="Nhập mã khoa">
                            </div>
                            <div class="form-group">
                                <strong>Chọn ngày kết thúc</strong>
                                <input type="date" name="end" value="{{$taodotdk->end}}" class="form-control" placeholder="Nhập tên khoa">
                            </div>
                            <div class="form-group">
