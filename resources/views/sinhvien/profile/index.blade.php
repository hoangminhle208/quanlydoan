            ...
            <div class="row">
                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="text-center">
                        <img class="profile-user-img img-fluid img-circle admin_picture" src="{{ DB::table('sinhviens')->where('MaSinhvien', Auth::user()->ma)->value('HinhAnh') }}" alt="User profile picture">
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="tab-content">
                        ...
                        <form class="form-horizontal" method="POST" action="{{route('user.update',Auth::user()->id)}}" id="AdminInfoForm">
                            ...
                            <div class="form-group row">
                            <label for="inputName2" class="col-sm-2 col-form-label">Loại tài khoản</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputName2" placeholder="Link hình ảnh" value="{{ Auth::user()->userType }}" name="userType" disabled>
